...
const Item3 = () => {
  return (
    <div className="w-full grid grid-cols-1 mdl:grid-cols-2 gap-12 sm:gap-16 mdl:gap-0 pb-[600px] mt-[6em] sm:mt-[8em] mdl:mt-[15em] mlg:mt-[15em]  mxl:mt-[34em] sxxl:mt-[27em] xxl:mt-[20em] vxl:mt-[23em] px-0 md:px-20 mdl:px-0 ">
      {/* Col 1 */}
