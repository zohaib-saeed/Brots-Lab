...
const Item2 = () => {
  return (
    <div className="w-full grid grid-cols-2 mt-[10em] mlg:mt-[16em]  sxl:mt-[19em] sxxl:mt-[23em] xxl:mt-[21.5em]  vxl:mt-[38em]   z-[10]">
      {/* Col 1  */}
      <div className="w-full lg:w-[97%]  flex flex-col items-start justify-start gap-5 ssm:gap-8 xxl:gap-12 relative">
        ...
        <div>
          {/* => Upto 1366px   */}
          <div className="w-[400px] h-[700px] -left-[3em] top-[26em] mlg:top-[24em]  absolute mxl:hidden flex items-center justify-center object-contain z-[-1]">
      ...
      {/* Col 2  */}
      <div className=" w-full flex items-end mxl:items-start justify-end pt-[19em] mxl:pt-0 xxl:pt-[9em] vxl:pt-0 relative vxl:pr-[6em]">
        <video
          autoPlay
          loop
          muted
