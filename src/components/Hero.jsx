...
const Hero = () => {
  return (
    <div className="w-full h-[930px] sxl:h-[100vh] flex flex-col items-center justify-end  sxl:justify-center px-6  lg:px-8 bg-[url('/images/hero-bg-sm.svg')] sxl:bg-[url('/images/hero-bg.svg')] bg-no-repeat bg-hero-sm sxl:bg-center bg-cover bg-black  relative">
      <div className="flex justify-start items-center absolute top-5 left-8">
        {/* => Logo  */}
        <div className="w-[120px] h-[32px] relative flex items-center justify-center object-contain">
          <Image src="/images/logo.svg" alt="" fill />
        </div>
      </div>
      <div className="w-full flex flex-col items-start justify-start gap-5 md:gap-8 px-2 sm:px-4 md:px-6 lg:px-8 pb-12 sxl:pb-0 sxl:pt-16 ">
        <h1 className="text-[80px] md:text-[100px] text-white font-bold leading-[81px] md:leading-[90px] lg:leading-[82px]">
        ...
        <p className="text-xl leading-[22px] text-mercury font-normal lg:font-medium text-left w-[81%] md:w-[55%] sxl:w-[42%]">
